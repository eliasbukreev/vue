export const documentation = [
  ...
  {
    $el: 'h2',
    children: 'Ответственный за обеспечение безопастности (администратор безопастности)',
    attrs: {
  ...
  },
  {
    ...
    {
    $el: 'h2',
    children: 'Ответственных за планирование и контроль мероприятий по защите информации в информационной системе',
    attrs: {
      class: 'text-md font-bold mb-2',
    },
  },
